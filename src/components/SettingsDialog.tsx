        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Switch
                id="autoDiscoverUSB"
                checked={settings.autoDiscoverUSB}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Switch
                ...
                checked={settings.autoDiscoverWireless}
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <Slider
                  value={[settings.wirelessDiscoveryInterval]}
                ...
                <div className="flex justify-between text-sm text-muted-foreground">
                  <span>10s</span>
                  <span className="font-medium">{settings.wirelessDiscoveryInterval}s</span>
                  <span>300s</span>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Switch
                ...
                checked={settings.showUnpairedDevices}
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Switch
                ...
                checked={settings.autoReconnectPaired}
